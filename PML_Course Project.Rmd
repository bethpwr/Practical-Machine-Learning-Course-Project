...
```{r}
train_data <- read.csv("/Users/User/Desktop/PML_beth/pml-training.csv", na.strings=c("NA","#DIV/0!", ""))
test_data <- read.csv("/Users/User/Desktop/PML_beth/pml-testing.csv", na.strings=c("NA","#DIV/0!", ""))
```
